...
input_folder = 'std_output_full_inventory'
...
vowel_df = pd.read_csv("../filtering/vowel_inventory_summary_base_inventory.csv")

# Load the other data file (make sure 'language' column exists in both)
all_vowel_df = pd.read_csv("../filtering/vowel_inventory_summary_full_inventory.csv")
