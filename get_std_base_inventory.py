...
# Define folder
filtered_folder = '../filtering/filtered_csv'
output_folder = 'std_output_base_inventory'
original_folder = '../data/vxc_data'
info_folder = '../data/vxc-documentation'
schwa = ["ə", "ə̃", "əː", "ə́", "ə̀", "ə̃", "ʷə"]
has_schwa = None
vowel_count = None
found_html_file = False
it_file_path = "../data/vxc_data/it_v17_dur_f0_formants.csv"
